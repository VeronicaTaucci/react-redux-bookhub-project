...
const Home = () => {
  ...
  const handleNoPic = (book) => {
    const newPic =
      "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.newyorker.com%2Fculture%2Fcultural-comment%2Fkirkus-reviews-plight-of-the-problematic-book-review&psig=AOvVaw0MumUZLKFjtqDcPNx71ZED&ust=1653090937781000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCMitiuXh7PcCFQAAAAAdAAAAABAD";
  ...
  return (
    <>
      ...
      <div className="heroDiv">
        <h1 className="quote">
          quote of the day:
          <span className="quoteCursive">"{randomQuote}"</span>{" "}
        </h1>
      ...
      <div className="searchResults">
        {!hideDiv ? (
          <h1>Hmm..no results, try searching for something else!</h1>
        ) : null}
        {searchedBooks.map((book) => (
          ...
          >
            <Card.Img
              variant="top"
              src={handleNoPic(book)}
              alt="cover picture of the book"
            />
